"""
This code is modified from Zhiquan Wen's repository.
...
def _load_dataset(dataroot, name, label2ans,ratio=1.0, qtype='', dataset='cpv2'):
    """Load entries
...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, dictionary, dataroot, image_dataroot, ratio, qtype='', adaptive=False, dataset='cpv2'):
        ...
        if dataset == 'cpv2':
            ...
            ans2label_path = os.path.join(dataroot, 'cache_v2', 'train_val_ans2label.pkl')
            label2ans_path = os.path.join(dataroot, 'cache_v2', 'train_val_label2ans.pkl')
        ...
        self.entries = _load_dataset(dataroot, name, self.label2ans, ratio, qtype=self.qtype, dataset=self.dataset)
        self.tokenize()
        self.tensorize()
    ...
    def __getitem__(self, index):
        ...
        # print("true feature id: ", true_feature_id)
