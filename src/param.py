...
def parse_args():
    ...
    # curriculum arguments
    parser.add_argument("--cl", default='linguistic',
                        choices=["linguistic", "linguistic_2", "linguistic_3", "ling_diff_type", "train_difficulty_lxmert",
                                 "train_difficulty_updn", "val_difficulty_updn"])
    parser.add_argument("--cl_reverse", action='store_true', default=True)
    # parser.add_argument("--cl_shuffle", action='store_true', default=False)
    parser.add_argument('--cl_diff_model_path', type=str, default=None,
                        help='directory to load pretrained difficulty checkpointed model')
    parser.add_argument("--qtype", action='store_true', default=True)


    parser.add_argument('--negs_num', type=int, default=1,
                        help='number of negative samples for question contrastive learning')
    parser.add_argument("--data_name", default='train', choices=["train", "val", "test"])
    

    parser.add_argument("--dataset", default=['cpv2', 'v2'])
    parser.add_argument("--mode", default='lxmert', choices=["lxmert", "lxmert_q_con", 'lxmert_nq_con'])
